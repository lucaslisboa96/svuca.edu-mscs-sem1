...
#    points = [makeRandomPoint(dimensions, lower, upper) for i in xrange(num_points)]
    points = [Point([66,170]),Point([73,210]),Point([72,165]),Point([70,180]),Point([74,185]),Point([68,155]),Point([65,150]),Point([64,120]),Point([63,125]),Point([67,140])]
    print points
    print points[0].__class__.__name__
